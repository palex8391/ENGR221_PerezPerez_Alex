...
class Preferences:
    ...
    PLAYER_IMAGE = os.path.join(IMG_DIR, "ladybug.png")
    # Image to display as food
    FOOD_IMAGE = os.path.join(IMG_DIR, "Tree.png")
    # Image to display as an enemy
    ENEMY_IMAGE = os.path.join(IMG_DIR, 'Sun.png')
